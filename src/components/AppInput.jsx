  ...
  return (
    <input
      className={`
        ...
        px-4 py-3 text-foreground text-[15px] leading-tight outline-none
...
export function AppSelect({ children, className = '', ...props }) {
  return (
    <div className="relative">
      <select
        className={`
          w-full min-h-[44px] appearance-none bg-card border border-border
          rounded-xl px-4 py-3 text-foreground text-[15px] leading-tight outline-none
          focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/30
